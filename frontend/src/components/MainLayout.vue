  ...
  <div id="app">
    <div>
      <nav :class="[primaryColor, 'nav-extended']">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li>
              <a class="dropdown-trigger" href="#!" data-target="dropdown1">
                Extensions<i class="material-icons right">arrow_drop_down</i>
              </a>
            </li>
            <li>
        ...
        <div v-if="showTabs" class="nav-content container">
          <ul class="tabs tabs-transparent hide-scrollbar">
            <li v-for="topic in topics" :key="topic" class="tab">
              <router-link :to="topic == 'all' ? '/' : '/topic/' + topic">
                {{ topic.replace('-', ' ') }}
              </router-link>
            </li>
          </ul>
